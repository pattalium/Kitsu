    ...
    @Test fun channelRecipientIsCanonicalSlotAndOnlyKnownConfiguredMetadataIsOffered() {
        ...
        val recipients = MessageComposerPolicy.channelRecipients(
            listOf(
                ...
                MeshChannel(2, true, "Ops", ChannelRegionScope.EU),
        ...
        assertTrue(recipients.first().supporting.orEmpty().contains("Legacy flood routing"))
        assertTrue(recipients.last().supporting.orEmpty().contains("only repeaters configured to allow #EU"))
    }
