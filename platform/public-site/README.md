...
but `site.js` exposes only the exact Android 2.2.5 / version-code 26 production
...
stable/release package `ptl.kitsu.app`, exact version 2.2.5 / code 26, bounded
...
`downloads/android-stable-2.2.3-20260826t132716z.json`; and the immediately
prior 2.2.4 authority is
`downloads/android-stable-2.2.4-20260828t092529z.json`. Each retains its raw
