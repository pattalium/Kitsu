...
if not exist "%VCVARS%" (
  echo TEST_BLOCKED kitsu_device_security: Visual C++ build tools not found
  exit /b 2
)
call "%VCVARS%" >nul
if errorlevel 1 exit /b %ERRORLEVEL%

set "OUT_DIR=%TEMP%\kitsu868-device-security-test"
...
"%OUT_DIR%\kitsu_device_security_test.exe"
...
popd
echo Kitsu device security tests passed.
