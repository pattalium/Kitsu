#!/usr/bin/env python3
"""Prepare or validate the minimal Kitsu 0.17.1 firmware publication stage.
...
FIRMWARE_VERSION = "0.17.1"
RELEASE_ID = "kitsu-0.17.1-reflashable-1"
...
def package_plan(
    ...
    if (
        ...
        raise ValueError("input package does not contain a verified 0.17.1 image marker")
...
def prepare(args: argparse.Namespace) -> int:
    ...
    print(
        "KITSU_FIRMWARE_0171_STAGE_READY "
...
def validate_stage(stage: Path, require_signature: bool, openssl: str) -> dict[str, Any]:
    ...
    if plan["schema"] != PLAN_SCHEMA or plan["firmware_version"] != FIRMWARE_VERSION or plan["release_id"] != RELEASE_ID:
        raise ValueError("publication plan is not the Kitsu 0.17.1 stable release")
...
def validate_command(args: argparse.Namespace) -> int:
    ...
    print(
        "KITSU_FIRMWARE_0171_STAGE_VALID "
