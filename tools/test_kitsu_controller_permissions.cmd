...
if not exist "%VCVARS%" (
  echo TEST_BLOCKED kitsu_controller_permissions: Visual C++ build tools not found
  exit /b 2
)
...
set "OUT_DIR=%TEMP%\kitsu868-controller-permissions-test"
...
cl /nologo /std:c++17 /EHsc /W4 /WX ^
  ...
  "%PROJECT%\tools\test_kitsu_controller_permissions.cpp" ^
  /Fe:"%OUT_DIR%\kitsu_controller_permissions_test.exe"
if errorlevel 1 (
...
"%OUT_DIR%\kitsu_controller_permissions_test.exe"
set "RESULT=%ERRORLEVEL%"
popd
exit /b %RESULT%
