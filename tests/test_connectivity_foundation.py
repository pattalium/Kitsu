...
class LocalConnectivityFoundationTests(unittest.TestCase):
    def test_partition_table_preserves_dual_apps_and_local_state(self) -> None:
        ...
        self.assertEqual(rows["nvs"], ("data", "nvs", 0x9000, 0x40000))
        self.assertEqual(rows["otadata"], ("data", "ota", 0x49000, 0x2000))
        self.assertEqual(rows["app0"], ("app", "ota_0", 0x50000, 0x300000))
        self.assertEqual(rows["app1"], ("app", "ota_1", 0x350000, 0x300000))
